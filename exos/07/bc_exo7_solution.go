...
func (s *ReplicaService) AddState(k string, value string) {
	fmt.Println("AddState: ", k, value)
...
func UnmarshallValue(data string) (string, string) {
	conversion, _ := json.Unmarshal(data)
